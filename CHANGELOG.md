...
- Added `ignoreEmptyLines` in FileLengthCheck to ignore empty lines (default = true)
- Changed default value for `max` in `FileLengthCheck` to 1000
- Changed `MethodLength` check to use tokentree
